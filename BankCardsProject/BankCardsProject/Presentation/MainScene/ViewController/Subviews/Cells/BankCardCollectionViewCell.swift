...
protocol BankCardCollectionViewCellProtocol {
    ...
    var bankOfCard: BankOfCard { get }
    var typeOfCard: TypeOfCard { get }
}
...
class BankCardCollectionViewCell: UICollectionViewCell {
    ...
    func configure(with model: some BankCardCollectionViewCellProtocol) {
        ...
        case .visa:
            cardTypeLogoImageView.image = Constants.Image.visa
        case .masterCard:
            cardTypeLogoImageView.image = Constants.Image.masterCard
        }
    }
}
